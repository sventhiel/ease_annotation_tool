...
{
    /// <summary>
    /// API endpoint for manage configurable UI elements
    /// </summary>
    public class UIElementsController : ApiController
    {
        ...
        /// </summary>
        /// <returns>UI elements list</returns>
        ...
        /// </summary>
        /// <returns>Found UI elements id's</returns>
        [System.Web.Http.Authorize]
        [System.Web.Http.HttpGet]
        ...
        /// Adds new UI element
        /// </summary>
        /// <param name="model">UI element data</param>
        /// <returns>Newly added UI element</returns>
        [System.Web.Http.Authorize]
