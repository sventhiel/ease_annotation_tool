...
{
    /// <summary>
    /// API endpoint for manage user's files
    /// </summary>
    ...
    public class UserFilesController : System.Web.Http.ApiController
    {
        ...
        /// <summary>
		/// Adds new user's file
		/// </summary>
		/// <returns>Operation result true/false</returns>
		[System.Web.Http.Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Sets access mode for user's files
        /// </summary>
        /// <returns>Operation result true/false</returns>
        [System.Web.Http.Authorize]
        [HttpPost]
