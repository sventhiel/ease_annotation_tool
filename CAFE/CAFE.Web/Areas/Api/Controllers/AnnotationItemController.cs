...
{
    /// <summary>
    /// API endpoint for manage annotation items
    /// </summary>
    //[Authorize]
    public class AnnotationItemController : ApiController
    {
        ...
        /// </summary>
        /// <returns>Newly added annotation item</returns>
        [Authorize]
        ...
        /// </summary>
        /// <returns>Updated annotation item</returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Imports Annotation Item from file
        /// </summary>
        ...
        /// <summary>
        /// Creates new Annotation Item from uploads user's files
        /// </summary>
        /// <returns>Annotation item url</returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Creates new Annotation Item from existing user's files
        /// </summary>
        /// <returns>Annotation item url</returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Creates new Annotation Item from uploads user's files and existing AI data
        /// </summary>
        /// <returns>Annotation item url</returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Creates new Annotation Item from existing user's files and existing AI data
        /// </summary>
        /// <returns>Annotation item url</returns>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Updates existing Annotation Item from uploads user's files
        /// </summary>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Updates existing Annotation Item from existing user's files
        /// </summary>
        [Authorize]
        [HttpPost]
        ...
        /// <summary>
        /// Exports Annotation Item
        /// </summary>
        /// <returns>Content of Annotation Item</returns>
        [Authorize]
        [HttpPost]
        ...
        /// </summary>
        /// <returns>Found Annotation Item</returns>
        [HttpGet]
        ...
        /// </summary>
        /// <returns>Cloned Annotation Item</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns all Annotation Items for current user
        /// </summary>
        /// <returns>User's Annotation items collection</returns>
        [Authorize]
        [HttpGet]
        ...
        /// </summary>
        /// <returns>Annotation items collection</returns>
        [Authorize]
        [HttpGet]
        ...
        /// <summary>
        /// Returns all Annotation Items via user's ID
        /// </summary>
        /// <returns>Annotation items collection</returns>
        [Authorize]
        [HttpGet]
        ...
        /// <summary>
        /// Copies Annotation Item
        /// </summary>
        /// <returns>Copied Annotation Item's ID</returns>
        [Authorize]
        [HttpGet]
        ...
        /// <summary>
        /// Changes Annotation Item's owner
        /// </summary>
        /// <param name="ownerId">new owner ID</param>
        /// <param name="annotationItemIds">annotation items ids</param>
        ...
        /// <summary>
        /// Returns all simple types vocabularies
        /// </summary>
        /// <returns>Vocabularies dictionary</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns current user's hidden helpers
        /// </summary>
        /// <returns>User's hidden helpers</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns Geological locations
        /// </summary>
        /// <param name="data">Search data</param>
        /// <returns>Found Geological locations</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Searches specifies for Organisms
        /// </summary>
        /// <param name="data">Search data</param>
        /// <returns>Found specifies</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Searches vocabularies
        /// </summary>
        /// <param name="searchToken">Search pattern</param>
        /// <param name="elementId">Vocabulary ui element ID</param>
        /// <returns>Found vocabularies</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns common vocabularies
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for time section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for biome section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for organism section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for chemical section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for method section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for process section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns vocabularies for space section
        /// </summary>
        /// <returns>Vocabularies list</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Performs extend for standard dictionaries 
        /// </summary>
        /// <param name="data">Data for extension</param>
        /// <returns>Extended dictionaries</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Imports vocabulary collection from file
        /// </summary>
        /// <param name="data">Data for import</param>
        /// <returns>Imported vocabulary collection</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Returns CSV header file for Annotation item class
        /// </summary>
        /// <param name="AIClassName">Annotation item class name</param>
        /// <param name="isExcel">Indicates that it's excel file</param>
        /// <returns>Status of operation</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns user's custom vocabulary values
        /// </summary>
        /// <returns>User's custom vocabulary values</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Returns all vocabularies values
        /// </summary>
        /// <returns>Vocabulary values collection</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Accepts user's vocabulary metadata
        /// </summary>
        /// <param name="values">User's vocabulary metadata</param>
        /// <returns>Status of operation true/false</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Saves global-wide vocabulary value (not for special user)
        /// </summary>
        /// <param name="model">Vocabulary value</param>
        /// <returns>Saved vocabulary value</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Removes global-wide vocabulary value (not for special user)
        /// </summary>
        /// <param name="model">Vocabulary value</param>
        /// <returns>Status of operation true/false</returns>
        [HttpPost]
        ...
        /// <summary>
        /// Returns all types of vocabularies
        /// </summary>
        /// <returns>Vocabularies types collection</returns>
        [HttpGet]
        ...
        /// <summary>
        /// Searches users by key
        /// </summary>
        /// <param name="userModel">Search model</param>
        ...
        /// <summary>
        /// Searches annotation items by search pattern
        /// </summary>
        /// <param name="keyWord">Search pattern</param>
        /// <returns>Found annotation items</returns>
        [HttpPost]
